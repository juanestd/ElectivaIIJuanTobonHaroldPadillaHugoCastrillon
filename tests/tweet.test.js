...
describe('Tweet API', () => {
    ...
    it('should not register a new tweet', async () => {
        //Arrange
        const newTweet = {
            message: 'Tweet de prueba'
        };
    ...
    it('should not get tweets by username', async () => {
        //Arrange
    ...
    it('should not get tweets by id', async () => {
        //Arrange
    ...
    it('should show message tweet not found', async () => {
        //Arrange
        const newTweet = {
            message: 'Tweet de prueba Actualizado'
        };
    ...
    it('should not delete a tweet', async () => {
        //Arrange
